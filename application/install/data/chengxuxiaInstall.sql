...
-- Host     : 127.0.0.1
-- Port     : 3306
-- Database : chengxuxia.com
-- 
-- Part : #1
-- Date : 2017-09-06 22:44:01
-- -----------------------------
...
INSERT INTO `cxxia_admin_rule` VALUES ('27', '5', '', '0', 'SearchCollect/index', '&amp;#xe683;', '超级搜索', '', '', '1', '1', '1', '1', '0');
INSERT INTO `cxxia_admin_rule` VALUES ('28', '5', '', '0', 'SpareCollect/index', '&amp;#xe6b5;', '备用采集', '', '', '1', '1', '3', '1', '0');
...
INSERT INTO `cxxia_admin_rule` VALUES ('35', '5', '5|', '0', 'DaogouCoupon/index', '&#xe6b3;', '好券清单', '', '', '1', '1', '2', '1', '0');
INSERT INTO `cxxia_admin_rule` VALUES ('38', '5', '', '0', 'Favorites/index', '&#xe645;', '选品库采集', '', '', '0', '1', '2', '1', '0');
...
INSERT INTO `cxxia_config` VALUES ('29', '1', 'WEB_WECAHT_TOKEN', '', '', '', '');
INSERT INTO `cxxia_config` VALUES ('30', '1', 'WEB_WECAHT_INFO', '', '', '', '');
...
CREATE TABLE `cxxia_goods` (
  ...
  `content` text,
  `goods_url` varchar(255) DEFAULT NULL COMMENT '商品URL地址',
  ...
  `click_url` text,
  `taokouling` varchar(50) DEFAULT NULL COMMENT '淘口令',
  `volume` int(11) DEFAULT NULL,
  `commission` double(11,2) DEFAULT '0.00' COMMENT '佣金金额',
  ...
  `coupon_receive` int(20) DEFAULT NULL COMMENT '优惠券已领取数量',
  `coupon_surplus` int(20) DEFAULT NULL COMMENT '优惠券剩余数量',
  `coupon_total` int(20) DEFAULT NULL COMMENT '优惠券总数',
  `coupon_explain` text COMMENT '优惠券说明',
...
INSERT INTO `cxxia_goods_cate` VALUES ('10', '&#xe680;', '文体', '0', '0', 'volume desc', '', '0', '0', '99', '1', '1', '户外用品,体育用品,办公用品,文具用品,文体折扣1折包邮', '户外用品,体育用品,办公用品,文具用品,汽车用品,1折,包邮', '每天为您推荐户外用品、体育用品、办公用品、文具用品、汽车用品等最新折扣商品，文体用品全场低至1折起包邮，每天10:00点开始！');
...
INSERT INTO `cxxia_goods_cate` VALUES ('14', '&#xe72b;', '其他', '0', '0', 'volume desc', '', '0', '0', '99', '1', '1', '服饰,配饰,母婴,女装,数码折扣1折包邮', '服饰,配饰,母婴,女装,数码,1折,包邮', '每天为您推荐服饰、配饰、美食等最新折扣商品，全场低至1折起包邮，每天10:00点开始！');
